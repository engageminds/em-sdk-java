...
req.setModel("MI 9");
// 用户ID，唯一
req.setUid("40ced950-3235-4556-8707-49c3caea9d15");
...
| session | String          | 当前会话 ID                                                                                                                                                                                                                              | 50e24b75-eb4a-486d-9a93-a1fd814e1e96 | ✖︎       |
| uid     | String          | 用户 ID，唯一                                                                                                                                                                                                                             | 50e24b75-eb4a-486d-9a93-a1fd814e1e96 | ✖︎       |
| atdk    | int            | 当前设备是否开启广告追踪，0 关闭，1开启                                                                                                                                                                                                                | 1                                    | ✖︎       |
| appv    | String      | APP 版本                                                                                                                                                                                                                               | 1.1.0                              | ✔      |
...
| fit     | long         | 当前设备 APP 首次安装时间，单位秒                                                                                                                                                                                                                   | 1693300890                         | ✔      |
| flt     | long          | 当前设备 APP 首次打开时间，单位秒                                                                                                                                                                                                                   | 1693300890                               | ✔     |
| gcy     | String        | 设备国家编码                                                                                                                                                                                                                               | cn                                  | ✖︎       |
| gp      | int         | 是否安装 Google Play，0 未安装，1 安装                                                                                                                                                                                                          | 1                              | ✖︎       |
| width   | int         | 设备屏幕宽度 px                                                                                                                                                                                                                            | 1080                           | ✔      |
| heigth  | int       | 设备屏幕高度 px                                                                                                                                                                                                                            | 2040 | ✔      |
| gaid    | String          | Android 设备广告标识符                                                                                                                                                                                                                      | f5bb825f-a1b8-44f8-a24d-10ca1ad1abe1 | ✔  |
| idfa    | String          | iOS 广告标识符                                                                                                                                                                                                                            |                                      | ✔      |
| idfv    | String          | iOS 供应商标识符                                                                                                                                                                                                                           |                                      | ✔      |
| ip      | String          | 设备 IP 地址                                                                                                                                                                                                                             | 1.1.1.1 | ✖︎       |
| jb      | int        | 设备是否越狱，0 正常，1 越狱                                                                                                                                                                                                                     | 0 | ✖︎       |
| lang    | String          | 设备语言                                                                                                                                                                                                                                 | zh | ✔      |
| make    | String          | 设备硬件制造商                                                                                                                                                                                                                              | Xiaomi | ✔      |
| mode    | String          | 设备型号                                                                                                                                                                                                                                 | MI 11 | ✔      |
| mccmnc  | String          | "移动国家代码" + "移动网络代码"                                                                                                                                                                                                                  | 4601 | ✖︎       |
| ntf     | int        | 当前设备 APP 是否开启通知权限，0 未开启，1 开启                                                                                                                                                                                                         | 1 | ✔      |
| oaid    | String          | 设备匿名标识符                                                                                                                                                                                                                              |                                      | ✖︎       |
| os      | int        | 设备操作系统<br>0:iOS,1:Android,2:HarmonyOS,<br>3:Mac,4:Windows,5:Linux                                                                                                                                                                    | 1 | ✔      |
| osv     | String        | 设备操作系统版本                                                                                                                                                                                                                             | 13 | ✔      |
| sco     | int        | 设备屏幕方向<br> 0:unknown,1:portrait,2:landscape                                                                                                                                                                                          | 1 | ✖︎       |
